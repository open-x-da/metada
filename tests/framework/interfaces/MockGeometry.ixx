/**
 * @file MockGeometry.ixx
 * @brief Mock implementation of IGeometry interface for testing (module version)
 * @ingroup tests
...
export module metada.tests.mock.geometry;
 ...
 public:
  ...
  void setTestResolution(const std::vector<size_t>& resolution) {
    ...
    ON_CALL(*this, getTotalPoints())
        .WillByDefault(Return(total_points_));
  }
  ...
  void setTestBounds(const std::vector<double>& min_bounds,
    ...
    ON_CALL(*this, getGridSpacing())
        .WillByDefault(Return(grid_spacing_));
  }
