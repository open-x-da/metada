...
// Array-based (grid) API for real WRFDA call with per-variable fields and grid metadata
...
int wrfda_xtoy_adjoint_grid(
    ...
    int num_obs,
    const double* obs_lats, const double* obs_lons, const double* obs_levels,
    double* inout_u, double* inout_v, double* inout_t, double* inout_q,
...
int wrfda_xtoy_adjoint_profiles(
    ...
    const double* levels,
    int num_obs,
    const int* obs_counts,
    const double* obs_lats,
    const double* obs_lons,
    const double* obs_levels_flat,
    double* inout_u, double* inout_v, double* inout_t, double* inout_q,
    double* inout_psfc
);
