...
class Geometry {
 public:
   ...
   */
  Geometry(float x_min = -30.0f, float x_max = 30.0f, float y_min = -30.0f,
           float y_max = 30.0f, float z_min = 0.0f, float z_max = 60.0f)
      : ptr_(geometry_create(x_min, x_max, y_min, y_max, z_min, z_max),
             geometry_deleter) {
    if (!ptr_) {
