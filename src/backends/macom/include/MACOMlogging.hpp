...
public:
     ...
     */
    static void setGlobalLevel(MACOMLogLevel level) {
        s_minLevel = level;
    }
     ...
     */
    static void enableComponentTags(bool enable) {
        s_showComponents = enable;
    }
     ...
     */
    static void log(MACOMLogLevel level, const std::string& component, const std::string& message) {
