...
class MockBackgroundErrorCovariance {
 public:
  ...
  explicit MockBackgroundErrorCovariance(
      [[maybe_unused]] const ConfigBackend& config_backend) {
  ...
  double computeQuadraticFormDiagonal(
      [[maybe_unused]] const StateType& state) const {
    return 1.0;  // Mock return value
  }

  /** @brief Mock method for applying inverse diagonal */
  template <typename StateType>
  void applyInverseDiagonal([[maybe_unused]] const StateType& state,
                            [[maybe_unused]] StateType& result) const {
    // Mock implementation
  }

  /** @brief Mock method for applying diagonal */
  template <typename StateType>
  void applyDiagonal([[maybe_unused]] const StateType& state,
                     [[maybe_unused]] StateType& result) const {
    // Mock implementation
  }
  ...
  template <typename StateType>
  void applySquareRootDiagonal([[maybe_unused]] const StateType& state,
                               [[maybe_unused]] StateType& result) const {
    // Mock implementation
  }
  ...
  template <typename StateType>
  void applyInverseEnsemble([[maybe_unused]] const StateType& state,
                            [[maybe_unused]] StateType& result) const {
    // Mock implementation
  }
  ...
  template <typename StateType>
  void applyEnsemble([[maybe_unused]] const StateType& state,
                     [[maybe_unused]] StateType& result) const {
    // Mock implementation
  }
  ...
  template <typename StateType>
  void applySquareRootEnsemble([[maybe_unused]] const StateType& state,
                               [[maybe_unused]] StateType& result) const {
    // Mock implementation
  }
  ...
  template <typename StateType>
  void applyInverseParametric([[maybe_unused]] const StateType& state,
                              [[maybe_unused]] StateType& result) const {
    // Mock implementation
  }
  ...
  template <typename StateType>
  void applyParametric([[maybe_unused]] const StateType& state,
                       [[maybe_unused]] StateType& result) const {
    // Mock implementation
  }
  ...
  template <typename StateType>
  void applySquareRootParametric([[maybe_unused]] const StateType& state,
                                 [[maybe_unused]] StateType& result) const {
    // Mock implementation
  }
  ...
  template <typename StateType>
  void applyInverseHybrid([[maybe_unused]] const StateType& state,
                          [[maybe_unused]] StateType& result) const {
    // Mock implementation
  }
  ...
  template <typename StateType>
  void applyHybrid([[maybe_unused]] const StateType& state,
                   [[maybe_unused]] StateType& result) const {
    // Mock implementation
  }
  ...
  template <typename StateType>
  void applySquareRootHybrid([[maybe_unused]] const StateType& state,
                             [[maybe_unused]] StateType& result) const {
    // Mock implementation
  }
  ...
  template <typename StateType>
  void applyInverseFull([[maybe_unused]] const StateType& state,
                        [[maybe_unused]] StateType& result) const {
    // Mock implementation
  }
  ...
  template <typename StateType>
  void applyFull([[maybe_unused]] const StateType& state,
                 [[maybe_unused]] StateType& result) const {
    // Mock implementation
  }
  ...
  template <typename StateType>
  void applySquareRootFull([[maybe_unused]] const StateType& state,
                           [[maybe_unused]] StateType& result) const {
    // Mock implementation
  }
};
