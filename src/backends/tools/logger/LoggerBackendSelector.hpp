#ifndef METADA_BACKENDS_TOOLS_LOGGER_LOGGERBACKENDSELECTOR_HPP_
#define METADA_BACKENDS_TOOLS_LOGGER_LOGGERBACKENDSELECTOR_HPP_
...
#endif  // METADA_BACKENDS_TOOLS_LOGGER_LOGGERBACKENDSELECTOR_HPP_
