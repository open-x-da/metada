/**
 * @file IGeometryIterator.ixx
 * @brief Interface for iterators traversing geometry grid points (module version)
 * @ingroup interfaces
 *
 * @details
 * This module provides the interface that geometry iterators must implement.
 * It defines the contract for traversing grid points in N-dimensional space.
 */

export module metada.framework.interfaces.geometry.iterator;
