/**
 * @file IGeometry.ixx
 * @brief Interface defining the contract for geometry implementations (module version)
 * @ingroup interfaces
 *
 * @details
 * This module provides the abstract interface that all geometry implementations
...
export module metada.framework.interfaces.geometry;
