/**
 * @file GeometryIterator.ixx
 * @brief Iterator implementation for traversing geometry grid points (module version)
 * @ingroup adapters
 *
 * @details
 * This module provides a concrete implementation of the IGeometryIterator
 * interface for traversing geometry grid points in N-dimensional space.
 */

export module metada.framework.adapters.geometry.iterator;
