 ...
 *
 * This interface defines the contract that all observation operator implementations
 * must follow. It provides a unified API for mapping between model space and
 * observation space.
 *
 * Key features:
...
public:
    ...
    virtual void apply(const IState& state, 
